				...
				<form class="form-horizontal">
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Consommation par jour}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="elec::consumption">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Production instantanée}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="elec::production::instant">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Production par jour}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="elec::production">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Renvoyé au réseaux par jour}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="elec::export">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Puissance nette instantanée}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="elec::net::power">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<legend>{{Gaz}}</legend>
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Consommation instantanée}}</label>
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="gaz::consumption::instant">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="gaz::consumption">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="water::consumption::instant">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="input-group">
										<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="water::consumption">
										<span class="input-group-btn">
											<a class="btn btn-default listCmdInfo roundedRight"><i class="fas fa-list-alt"></i></a>
										</span>
									</div>
